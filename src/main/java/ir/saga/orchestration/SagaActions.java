...
public class SagaActions<Data extends SagaData> {
    ...
    public static class Builder<Data extends SagaData> {
    ...
    public static <Data extends SagaData> Builder<Data> builder() {
        return new Builder<>();
    }
